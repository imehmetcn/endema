...
<html lang="en">
  <head>
    ...
    <title>Endema Yacht | Yacht Building & Refitting</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
    <meta content="telephone=no" name="format-detection"/>
    <meta name="HandheldFriendly" content="true"/>
    <meta name="description" content="Endema Marine Ltd, founded in 2014, specializes in the construction and refit of over 30 yachts. With a strong background in naval architecture since 1998, Endema has achieved successful project deliveries through a focus on excellence and a customer-centric approach. Investing in human resources, machinery, and technology, Endema stands out from competitors by prioritizing quality and reliability." />
    ...
    <meta property="og:description" content="Endema Marine Ltd, founded in 2014, specializes in the construction and refit of over 30 yachts. With a strong background in naval architecture since 1998, Endema has achieved successful project deliveries through a focus on excellence and a customer-centric approach. Investing in human resources, machinery, and technology, Endema stands out from competitors by prioritizing quality and reliability." />
 ...
 <div class="curtain transition-curtain" id="js-page-transition-curtain">
  ...
  <!-- PAGE HEADER -->
      ...
      <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto header__col header__col-left"><a class="logo" href="https://endema.com.tr/">
                ...
                <img class="logo__img-primary" src="https://endema.com.tr/wp-content/themes/endema/img/assets/logo/logo.webp" alt="Endema Logo" width="150" height="20"/>
                    <img class="logo__img-secondary" src="https://endema.com.tr/wp-content/themes/endema/img/assets/logo/logo.webp" alt="Endema Logo" width="150" height="20"/>
                </div></a>
            </div>
            <!-- - logo -->
            <!-- burger icon -->
            ...
            <ul class="menu-overlay js-menu-overlay">
              ...
              <li class="menu-item-has-children">
                <a class="h2" href="https://endema.com.tr/refit" data-pjax-link="overlayMenu">
                  <div class="menu-overlay__item-wrapper split-text js-split-text" data-split-text-type="lines">REFIT</div></a>
              </li> 
              <li class="menu-item-has-children">
                <a class="h2" href="https://endema.com.tr/newbuild" data-pjax-link="overlayMenu">
                  <div class="menu-overlay__item-wrapper split-text js-split-text" data-split-text-type="lines">NEWBUILD</div></a>
              </li> 
              <li class="menu-item-has-children">
          ...
          <div class="header__wrapper-overlay-widgets">
            <div class="row">
              ...
              <div class="col-lg-4 header__widget">
                <div class="header__widget-title small-caps js-split-text split-text textbg" data-split-text-type="lines">Endema Contacts</div>
                <div class="header__widget-content js-split-text split-text" data-split-text-type="lines">
                  <p><a href="tel:+902425027374">0242 502 7374</a> <br/> <a href="mailto:info@endema.com.tr">info@endema.com.tr</a>
                  </p>
                </div>
              </div>
              <!-- - widget TEXT -->
              <!-- widget TEXT -->
              <div class="col-lg-4 header__widget">
                <div class="header__widget-title small-caps js-split-text split-text textbg" data-split-text-type="lines">Endema Adress</div>
                <div class="header__widget-content js-split-text split-text" data-split-text-type="lines">
              ...
              <!-- widget TEXT -->
              <div class="col-lg-4 header__widget">
                <div class="header__widget-title small-caps js-split-text split-text textbg" data-split-text-type="lines">Endema SocialMedia</div>
                <div class="header__widget-content js-split-text split-text" data-split-text-type="lines">
              ...
              <header class="row section-masthead__header justify-content-center">
                <div class="col">
                  ...
                  <div class="section-masthead__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                    <h1 class="yat-baslik mt-0 mb-0">M/Y ARIELLA</h1>
                  </div>
                  <div class="w-100"></div>
                ...
                <div class="section-video__container section section_h-700 section-content__image">
                  <div class="section__bg">
                    <div class="section-image__wrapper" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                      <div>
                        <video class="of-cover" src="https://endema.com.tr/wp-content/themes/endema/img/assets/video/2.webm" autoplay="autoplay" playsinline="playsinline" muted="muted" loop="loop"></video>
                    </div>
                    </div>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-6">
                        ...
                        <section class="section section-image section_h-900">
                            <video class="of-cover" src="https://endema.com.tr/wp-content/themes/endema/img/assets/refit/my-wellesley/wellesley-work-1.mp4" autoplay="autoplay" playsinline="playsinline" muted="muted" loop="loop"></video>
                        </div>
                    </div>
                      </div>
                  <div class="col-lg-6">
                    ...
                    <section class="section section-content clearfix container-fluid" data-arts-os-animation="data-arts-os-animation">
                        <div class="section-content__inner">
                          ...
                          <div class="section-content__heading split-text js-split-text text-center" data-split-text-type="lines,words" data-split-text-set="words">
                            ...
                            <span class="endema-yat">Gold plating & crockery works</span>
                        </div>
                          <div class="w-100"></div>
                          <div class="section-content__text split-text js-split-text mt-1 text-center" data-split-text-type="lines" data-split-text-set="lines">
                            <h6>Add a touch of luxury with our gold plating and custom crockery services, designed to elevate your yacht’s elegance and refinement</h6>
                          </div>
                          <div class="w-100"></div>
                          <div class="mb-1 mb-md-1"></div>
                          <div class="w-100"></div>
                          <div class="section-content__heading split-text js-split-text text-center" data-split-text-type="lines,words" data-split-text-set="words">
                            ...
                            <h2 class="endema-yat">Complete exterior paint work</h2>
                          </div>
                          <div class="w-100"></div>
                          <div class="section-content__text split-text js-split-text mt-1 text-center" data-split-text-type="lines" data-split-text-set="lines">
                            <h6>Protect and beautify your yacht with a complete exterior paint job, providing a flawless, durable finish that stands up to the elements</h6>
                          </div>
                          <div class="w-100"></div>
                          <div class="mb-1 mb-md-1"></div>
                          <div class="w-100"></div>
                          <div class="section-content__heading split-text js-split-text text-center" data-split-text-type="lines,words" data-split-text-set="words">
                            ...
                            <h2 class="endema-yat">Shaft works</h2>
                          </div>
                          <div class="w-100"></div>
                          <div class="section-content__text split-text js-split-text mt-1 text-center" data-split-text-type="lines" data-split-text-set="lines">
                            <h6>Expert shaft services to ensure precise alignment, smooth operation, and enhanced performance of your yacht’s propulsion system</h6>
                          </div>
                        </div>
                    </div>
                      </section>
            ...
            <div class="container-fluid no-gutters">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="container-fluid container-fluid_paddings">
                        ...
                        <div class="section-content__inner">
                          ...
                          <div class="section-content__heading split-text js-split-text text-center" data-split-text-type="lines,words" data-split-text-set="words">
                            ...
                            <h2 class="endema-yat">Renewal of galley</h2>
                        </div>
                          <div class="w-100"></div>
                          <div class="section-content__text split-text js-split-text mt-1 text-center" data-split-text-type="lines" data-split-text-set="lines">
                            <h6>Upgrade your galley with modern amenities and high-quality finishes, combining functionality with style for a perfect onboard kitchen</h6>
                          </div>
                          <div class="w-100"></div>
                          <div class="mb-1 mb-md-1"></div>
                          <div class="w-100"></div>
                          ...
                          <div class="section-content__heading split-text js-split-text text-center" data-split-text-type="lines,words" data-split-text-set="words">
                            ...
                            <h2 class="endema-yat">Interior lacquer works of main saloon</h2>
                          </div>
                          <div class="w-100"></div>
                          <div class="section-content__text split-text js-split-text mt-1 text-center" data-split-text-type="lines" data-split-text-set="lines">
                            <h6>Refresh your main saloon with our premium lacquer services, offering a high-gloss, durable finish that enhances the interior’s beauty and sophistication</h6>
                          </div>
                        </div>
                    </div>
                      </section>
                  ...
                  <div class="col-lg-6">
                    ...
                    <section class="section section-image section_h-900">
                        <div class="lazy-bg" data-src="https://endema.com.tr/wp-content/themes/endema/img/assets/refit/my-ariella/ariella-work-1.jpeg"></div>
                    </div>
                </div>
                  </div>
              </div>
                    ...
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <div class="figure-icon__header">
                          ...
                          <div class="figure-info__value paragraph">32,4 M</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                    ...
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <div class="figure-icon__header">
                          ...
                          <div class="figure-info__value paragraph">6,4 M</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                    ...
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <div class="figure-icon__header">
                          ...
                          <div class="figure-info__value paragraph">2,4 M</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                    ...
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <div class="figure-icon__header">
                          ...
                          <div class="figure-info__value paragraph">RINA</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                    ...
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <div class="figure-icon__header">
                          ...
                          <div class="figure-info__value paragraph">146 T</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                    ...
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <div class="figure-icon__header">
                          ...
                          <div class="figure-info__value paragraph">2016</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide overflow d-flex-centered text-center">
            <div class="w-100 h-100" data-swiper-parallax="10%" data-swiper-parallax-zoom="10%">
              <div class="slider__zoom-container w-100 h-100"><img class="swiper-lazy" src="#" data-src="https://endema.com.tr/wp-content/themes/endema/img/assets/refit/my-ariella/1.jpg" width="1120" height="700" alt=""/></div>
            </div>
          </div>
          <div class="swiper-slide overflow d-flex-centered text-center">
            <div class="w-100 h-100" data-swiper-parallax="10%" data-swiper-parallax-zoom="10%">
              <div class="slider__zoom-container w-100 h-100"><img class="swiper-lazy" src="#" data-src="https://endema.com.tr/wp-content/themes/endema/img/assets/refit/my-ariella/2.jpg" width="1120" height="700" alt=""/></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- - section IMAGES -->
    ...
    <p class="footeryazı"><small>2024 Endema Yacht. All Rights Reserved.</small></p>
    </div>
    <!-- - content -->
    </section>
    </div>
   ...
   <!-- PhotoSwipe -->
   <div class="pswp" tabindex="-1" role="dialog" aria-hidden="true" data-arts-theme-text="dark">
   <!-- background -->
